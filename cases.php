...
#case img { float:left; }
#case ul { list-style:none; padding:0; float:left;}
#case h3 { font-family:Microsoft YaHei,微软雅黑; margin-bottom:0; font-weight:bolder; }
.h3-right { text-align:right; }
#case .col-lg-offset-4 ul,#case .col-lg-offset-4 img{
	float: right;
}
</style>
	<div id="primary" class="site-content">
		<div id="content" role="main" style="background:#cfe8cb;font-family:Microsoft YaHei,微软雅黑;font-size:16px;">
            ...
            <div id="case" class="container">
                <div class="col-xs-12 col-md-10 col-lg-8">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-1.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                ...
                <div class="col-xs-12 col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-9"><ul class="text-right">
                        <li style="font-weight:bold">【商户面临的问题】</li>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-2.jpg">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-12 col-md-10 col-lg-8">
                    <h3>通讯、数码电子</h3>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-3.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                        <li style="font-weight:bold">【商户面临的问题】</li>
                ...
                <div class="col-xs-12 col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-4.jpg">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-12 col-md-10 col-lg-8">
                    <h3>杂货店、便利店</h3>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-5.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                        <li style="font-weight:bold">【商户面临的问题】</li>
                        <li>经常有客户需要刷卡；</li>
                ...
                <div class="col-xs-12 col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-6.jpg">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-12 col-md-10 col-lg-8">
                    <h3>美容店</h3>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-7.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                        <li style="font-weight:bold">【商户面临的问题】</li>
                        <li>时尚客户群，首选刷卡支付；</li>
                ...
                <div class="col-xs-12 col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-8.jpg">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-12 col-md-10 col-lg-8">
                    <h3>五金</h3>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-9.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                        <li style="font-weight:bold">【商户面临的问题】</li>
                        <li>部分大额订单，无法现金支付；</li>
                ...
                <div class="col-xs-12 col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-10.jpg">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-12 col-md-10 col-lg-8">
                    <h3>家具建材</h3>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-11.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                        <li style="font-weight:bold">【商户面临的问题】</li>
                ...
                <div class="col-xs-12 col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-12.jpg">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-12 col-md-10 col-lg-8">
                    <h3>快递</h3>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-13.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                        <li style="font-weight:bold">【商户面临的问题】</li>
                        <li>部分快递需要货到付款；</li>
                ...
                <div class="col-xs-12 col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-14.jpg">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-12 col-md-10 col-lg-8">
                    <h3>药店</h3>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                    	<img class="img-responsive" src="<?php echo get_template_directory_uri()?>/images/cases/case-15.jpg">
                    </div>
				    <div class="col-xs-12 col-sm-8 col-md-9"><ul>
                        <li style="font-weight:bold">【商户面临的问题】</li>
                        <li>客户多有刷卡习惯；</li>
