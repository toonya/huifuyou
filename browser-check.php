...
function browser_alert() {
	wp_die('<p>Please update your browser.</p>
			...
			<ul>
				<li><a target="_blank" href="http://browser.qq.com/index_m.html">QQ浏览器（这个网页很酷的哟）</a></li>
				<li><a target="_blank" href="http://se.360.cn/">360安全浏览器</a></li>
				<li>或者其它浏览器，看您的喜好。</li>
			</ul>
			<p>如果你仍然执着于IE，那么请下载一个IE 9版本（不支持xp系统）吧。IE8以下正在渐渐被淘汰。</p>
			<ul>
				<li><a target="_blank" href="">IE9(windows7 32位)</a></li>
				<li><a target="_blank" href="">IE9(windows7 64位)</a></li>
