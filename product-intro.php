	...
	<div id="primary" class="site-content">
		<div id="content" role="main" style="padding:0;">
            ...
            <div style="background:#f4f4f4">
                ...
                <p style="text-align:right;font-family:Microsoft YaHei,微软雅黑;font-size:14px;margin:0px 110px 50px 50px;"><a style="background:lightblue; border-radius:3px;padding:5px;" href="<?php bloginfo('url')?>/?page_id=95" target="_blank">关于乐刷商务版＞＞</a></p>
                <div class="my-leshua">
