	...
	<div id="primary" class="site-content">
		<div id="content" role="main" style="padding:0;">
            ...
            <div style="background:#f4f4f4">
                ...
                <p style="font-family:Microsoft YaHei,微软雅黑;font-size:24px;margin:50px 50px 0 50px;">乐刷商务版是一款支持商户进行刷卡收款，并通过银联认证的移动手机刷卡器。可以用于门店收款或上门收款。</p>
                <p style="font-family:Microsoft YaHei,微软雅黑;font-size:24px;margin:50px 50px 0 50px;"><a href="" target="_blank">→关于乐刷</a></p>
                <div class="my-leshua">
