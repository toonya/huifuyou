...
.about-a a:hover { background:none; }
</style>
	<div id="primary" class="site-content">
		<div id="content" role="main" style="padding:0;">
            ...
            <div style="background:#f4f4f4">
                ...
                <p class="about-a" style="font-family:Microsoft YaHei,微软雅黑;font-size:14px;margin:0px 110px 50px 50px;"><a style="background:lightblue; border-radius:3px;padding:5px;" href="" target="_blank">关于乐刷﹥＞</a></p>
                <div class="my-leshua">
