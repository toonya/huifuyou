	...
	<div id="primary" class="site-content">
		<div id="content" role="main" style="padding:0;">
            ...
            <div style="background:#f4f4f4">
                ...
                <a href="http://item.taobao.com/item.htm?spm=a1z10.3.w4002-1198074655.91.v0ip1z&id=20396079117" target="_blank"><img src="<?php echo get_template_directory_uri()?>/images/product-intro/buynow.png"></a>
            </div>
            <!--结束代码-->
