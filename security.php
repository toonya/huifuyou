            ...
            <div class="col-xs-12 col-md-10 col-md-offset-1">
                <div id="feature-1">
                    ...
                    <div class="hidden-xs col-xs-offset-2 col-sm-5 col-lg-push-6 col-md-push-6 col-sm-push-6">
                        <img class="img-responsive" style="margin:24px;vertical-align:top" src="<?php echo get_template_directory_uri()?>/images/security/unionpay.png">
                    </div>
                ...
                <div id="feature-2">
                    ...
                    <div class="hidden-xs col-sm-5 col-lg-push-6 col-md-push-6 col-sm-push-6">
                        <img class="img-responsive pull-right" style="margin:24px;vertical-align:top" src="<?php echo get_template_directory_uri()?>/images/security/2.png">
                    </div>
                ...
                <div id="feature-3" style="border-bottom:none;margin-bottom:0">
                    ...
                    <div class="hidden-xs col-sm-5 col-lg-push-6 col-md-push-6 col-sm-push-6">
                        <img class="img-responsive  pull-right" style="margin:24px;vertical-align:top" src="<?php echo get_template_directory_uri()?>/images/security/1.png">
                    </div>
                    <div class="visible-xs col-xs-4 pull-right">
                        <img class="img-responsive  pull-right" style="margin:24px;vertical-align:top" src="<?php echo get_template_directory_uri()?>/images/security/1.png">
                    </div>
