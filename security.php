...
.font-12 { font-size:12px; }
	...
	<div id="primary" class="site-content">
		<div id="content" role="main" style="background:#f4f4f4; text-align:center;">
            ...
            <!--开始代码-->
                <p id="feature-1">通过银联相关认证<img style="vertical-align:top;margin-left:300px;" src="<?php echo get_template_directory_uri()?>/images/security/unionpay.png"></p>
                <p id="feature-2">软硬件双重加密<img style="vertical-align:top;margin-left:400px;" src="<?php echo get_template_directory_uri()?>/images/security/2.png"></p>
